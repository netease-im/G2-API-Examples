...
## 1.项目简介
这个开源示例项目演示了如何快速集成 网易云信 新一代（G2）音视频 SDK，实现屏幕共享的音视频通话。
...
[在线体验](https://app.yunxin.163.com/webdemo/g2web/index.html#/?path=screenShare)
...
运行后通过 https://localhost:8020/index.html#/?path=screenShare 进行访问
