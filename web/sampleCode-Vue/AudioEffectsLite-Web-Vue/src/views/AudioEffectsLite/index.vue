  ...
  <div class="wrapper">
    <div class="content">
      ...
      <el-card class="control-container" body-style="backgroundColor: initial">
        <el-row>
          <el-col :span="8"><span class="demonstration">变声</span></el-col>
          <el-col :span="8">
            <el-button type="success" @click="enableAudioEffect"
              >打开</el-button
            >
          </el-col>
          <el-col :span="8">
            <el-button type="success" @click="disableAudioEffect"
              >关闭</el-button
            >
          </el-col>
        </el-row>
...
export default {
  ...
  methods: {
    enableAudioEffect() {
      this.localStream.setAudioEffectLite("Pitch", 0.4);
      this.openEffect = true;
    },
    disableAudioEffect() {
      this.localStream.disableAudioEffectLite();
