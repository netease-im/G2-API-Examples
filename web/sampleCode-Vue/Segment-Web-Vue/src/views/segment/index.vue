    ...
    <div class="content">
      ...
      <el-card class="control-container" body-style="backgroundColor: initial">
        <el-row>
          ...
          <el-col :span="8"
            ><el-button type="primary" @click="registerVitrualBackground"
              >注册</el-button
            ></el-col
          >
          <el-col :span="8"
            ><el-button
              type="success"
              :disabled="!registerBodySegment"
              @click="openVitrualBackground"
              >打开</el-button
            ></el-col
          >
        </el-row>
        <el-row>
          ...
          <el-col :span="16">
            <el-color-picker
              :disabled="!openBodySegment"
              v-model="color"
              @change="setBackGround({ type: 'color', color: color })"
            ></el-color-picker>
          </el-col>
        </el-row>
        <el-row>
          ...
          <el-col :span="16">
            <el-slider
              ...
              :min="1"
              :max="10"
              @input="setBackGround({ type: 'blur', level: level })"
            ></el-slider>
          </el-col>
        </el-row>
        <el-row>
          ...
          <el-col :span="16">
            <el-image
              ...
              :src="bgSrc"
              @click="setBackGround({ type: 'image', source: bgSrc })"
            ></el-image>
            <el-image
              style="width: 80px; height: 80px"
              :src="bg2Src"
              @click="setBackGround({ type: 'image', source: bg2Src })"
            ></el-image>
          </el-col>
        </el-row>
      </el-card>
    ...
    return {
      ...
      virtualBackgroundPluginConfig: {
        simd: {
          ...
          wasmUrl:
            "https://yx-web-nosdn.netease.im/package/NIM_Web_VirtualBackground_simd_v5.8.20.wasm" +
        ...
        nosimd: {
          ...
          pluginObj: VirtualBackground,
          wasmUrl:
            "https://yx-web-nosdn.netease.im/package/NIM_Web_VirtualBackground_nosimd_v5.8.20.wasm" +
            `?download=${new Date().valueOf()}`,
        },
      },
