<template>
  <div class="wrapper">
    ...
    <el-drawer title="选择视频源" :visible.sync="drawer" direction="ltr">
      <div class="pl20 mb20">
                ...
                reader.addEventListener('load', (e) => {
                    ...
                    videoDom.oncanplay = (e) => {
                        ...
                        this.canvasTimer = setInterval(() => {
                            this.canvas
                                .getContext('2d')
                                .drawImage(videoDom, 0, 0, this.canvas.width, this.canvas.height);
                        }, 50);
