...
class VideoCallingPage extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _VideoCallingPageState();
  }
}

class _VideoCallingPageState extends State<VideoCallingPage> {
  final FocusNode _channelFocusNode = FocusNode();
  ...
  Future<void> _startVideoCalling(BuildContext context) async {
