 ...
 */
var GetPermissionKey = function (appKey, permissionSecret, channelName, uid, privilege, ttlSec) {
...
var GetPermissionKeyWithCurrentTime = function (appKey, permSecret, channelName, uid, privilege, ttlSec, curTimeSec) {
    const permKey = {
        appkey: appKey,
        checksum: "",
        cname: channelName,
...
var base64EncodeUrl = function (input) {
