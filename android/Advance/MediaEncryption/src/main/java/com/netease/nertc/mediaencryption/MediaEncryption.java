package com.netease.nertc.mediaencryption;
...
public class MediaEncryption extends AppCompatActivity implements NERtcCallback,View.OnClickListener {
    ...
    private void mediaencry() {
        String key = "eSquTOdDkM@jePv0S)w2nN$f_mwit1y^%Cj(p3pd4fW^m+)fk2D47wHe+ks*6xSH6bkOH6J_CQptv*bO&Q0**yOMM_mmzHmk#e$au~6Rp@KtQ4UHhDpB#R4B@VX6Juxh";
        NERtcEncryptionConfig neRtcEncryptionConfig= new NERtcEncryptionConfig(NERtcEncryptionConfig.EncryptionMode.GMCryptoSM4ECB, key);
        NERtcEx.getInstance().enableEncryption(true, neRtcEncryptionConfig);
    }
