...
public class ByteDanceBeautyActivity extends AppCompatActivity implements NERtcCallback,View.OnClickListener {
    private static final String TAG = "ByteDanceBeautyActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_byte_dance_beauty);
        initView();
    }
    ...
    private void initView() {
        ...
        mStartJoinBtn = findViewById(R.id.btn_joinChannel);
    ...
    public void onClick(View view) {
        ...
        if(id == R.id.iv_back){
            exit();
        }else if(id == R.id.btn_joinChannel){
            startJoinRoom();
        }
    }
